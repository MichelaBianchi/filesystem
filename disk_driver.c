...
int DiskDriver_readBlock(DiskDriver* disk, void* dest, int block_num){
	...
	// Se il blocco è vuoto non lo leggo
...
int DiskDriver_writeBlock(DiskDriver* disk, void* src, int block_num){
	...
	// Setto che il blocco è occupato ora
...
int DiskDriver_freeBlock(DiskDriver* disk, int block_num){
	...
	// Allora lo setto a 0 se non è libero
	...
	// se il numero del blocco è minore del primo libero
	if(block_num < disk->header->first_free_block)
...
// la write non scrive su un blocco già occupato
